...
class CompanyFields implements OptionSourceInterface
{
    const FIELD_SOURCE = 'company';
    ...
    public function toOptionArray(): array
    {
        ...
        try {
            $options = [];
            $groups = $this->hubspotHelper->getApi()->getCompanyPropertyGroups();
            $properties = $this->hubspotHelper->getApi()->getCompanyProperties();
